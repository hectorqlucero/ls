...
- `:href` — Subgrid endpoint, generated by the subgrid builder. Format: `/admin/<child><parent>` (concatenate child+parent), e.g. `/admin/user_contactsusers`
  ...
  (let [labels ["Name" "Email"]
        ...
        args {:new true :edit true :delete true
              :subgrids [{:title "Contacts"
                          ...
                          :foreign-key "user_id"
                          :href "/admin/user_contactsusers"
                          :icon "bi bi-people"
                          :label "Contacts"}
                         {:title "Roles"
                          :table-name "user_roles"
                          :foreign-key "user_id"
                          :href "/admin/user_rolesusers"
...
Notes:
- The subgrid `:href` is created by the `lein subgrid` generator. It follows the composite pattern `/admin/<child><parent>`; for example, `user_contacts` under `users` becomes `/admin/user_contactsusers`.
